...
class CameraSync {
  ...
  updateCamera(ev) {
    ...
    // }
    this.cameraTranslateZ = new Matrix4().makeTranslation(
      0,
      0,
    ...
    if (this.camera instanceof OrthographicCamera) {
      this.camera.projectionMatrix = makeOrthographicMatrix(
        w / -2,
        w / 2,
        h / 2,
        h / -2,
  ...
  updateCameraState() {
    ...
    const height =
      altitude - this.mercatorZfromAltitude(t._centerAltitude, t.center.lat);
    ...
    return [
      ...
      this.mercatorZfromAltitude(t._centerAltitude, t._center.lat) +
        (-dir[2] * distance) / updatedWorldSize,
    ];
  }
